tellraw @a[tag=m_player,tag=!m_aura_dead] ["",{"text":"[","bold":true,"color":"gold"},{"text":"!","bold":true,"color":"yellow"},{"text":"]","bold":true,"color":"gold"},{"text":" Only ","color":"green"},{"text":"3","bold":true,"color":"green"},{"text":" more people alive!","color":"green"},{"text":" +","bold":true,"color":"green"},{"score":{"name":"$game","objective":"m_aura_topPoints"},"bold":true,"color":"dark_green"},{"text":" emeralds!","color":"green"}]
